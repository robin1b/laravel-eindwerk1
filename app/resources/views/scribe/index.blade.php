    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="items">
                    <a href="#items">Items</a>
                                ...
                                <a href="#items-GETapi-items">Get all items.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="items-POSTapi-items">
                                <a href="#items-POSTapi-items">Create a new item.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="items-GETapi-items--id-">
                                <a href="#items-GETapi-items--id-">Get item details.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="items-DELETEapi-items--id-">
                                <a href="#items-DELETEapi-items--id-">Delete an item.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>API endpoints for managing items.</p>
                                ...
                                <h2 id="items-GETapi-items">Get all items.</h2>

<p>
</p>

<p>Retrieves a paginated list of items. Supports filtering by status, name,
creation date and page size.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/items?status=new&amp;name=foo&amp;created_after=2025-01-01&amp;per_page=15" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="GETapi-items"
               value="new"
               data-component="query">
    <br>
<p>Filter by status. Allowed values: new, in_progress, done. Example: <code>new</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="GETapi-items"
               value="foo"
               data-component="query">
    <br>
<p>Filter by partial name match. Example: <code>foo</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>created_after</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="created_after"                data-endpoint="GETapi-items"
               value="2025-01-01"
               data-component="query">
    <br>
<p>date Filter items created on or after this date (YYYY-MM-DD). Example: <code>2025-01-01</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<p>Number of items per page. Example: <code>15</code></p>
                    ...
                    <h2 id="items-POSTapi-items">Create a new item.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The name of the item. Example: <code>New item</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The description of the item. Example: <code>This is an item.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be one of: new, in_progress, done. Example: <code>new</code></p>
        </div>
        </form>

                    <h2 id="items-GETapi-items--id-">Get item details.</h2>
...
<p>The ID of the item. Example: <code>1</code></p>
                    ...
                    <h2 id="items-DELETEapi-items--id-">Delete an item.</h2>
